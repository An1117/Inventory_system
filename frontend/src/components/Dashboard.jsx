        ...
        <div className="row">
          ...
          <div className="col-md-10 offset-md-2" style={{ marginTop: '60px' }}>
            <div className="mt-4 px-3">
              ...
              {/* Buttons for Inventory and Add Inventory */}
              <div className="row mt-5">
                <div className="col-md-6">
                  <Link to="/dashboard/inventory/add1">
                    <Button variant="primary" className="w-100">Go to Inventory</Button>
                  </Link>
                </div>
                <div className="col-md-6">
                  <Link to="/dashboard/inventory/add">
                    <Button variant="success" className="w-100">Add Inventory</Button>
                  </Link>
                </div>
              </div>
            </div>
